...
object AppConfig {
    ...
    const val keyAlias = "platform"
    const val storeFile = "../keystore/platform.jks"
}
...
object DependenciesExt {
    ...
    const val extUnit = "androidx.test.ext:junit:1.1.1"
    ...
    const val mvvm = "com.github.Reginer:MVVMHub:1.9.11"
    ...
    const val toast = "com.hjq:toast:8.0"
    ...
    const val recyclerViewAdapter = "com.github.CymChad:BaseRecyclerViewAdapterHelper:3.0.3"
